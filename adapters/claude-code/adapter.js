/**
 * Claude Code adapter for Intent Broker
 * Connects Claude Code to the Intent Broker for multi-agent collaboration
 */
...
export class ClaudeCodeAdapter {
  ...
  async connect() {
    ...
    console.log(`✓ Registered as ${this.participantId}`);
  ...
  async handleIntent(event) {
    ...
    if (handler) {
      try {
        ...
        console.error(`Error handling ${event.kind}:`, error.message);
      }
    }
  }
